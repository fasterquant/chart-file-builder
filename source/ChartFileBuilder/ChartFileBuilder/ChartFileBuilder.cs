...
namespace ChartFileBuilder
{
    public partial class ChartFileBuilder : Form
    {
        ...
        private void btnGenerateFilesBatch_Click(object sender, EventArgs e)
        {
            ...
            var percentGainSortedDir = tbOutputDir.Text + Path.DirectorySeparatorChar + "percentgainsorted";
        ...
        private void CreateChartFile(string[] currentFiles, string inputDir, string outputDir, string resultDir, string percentGainSortedDir, int tradeNumber, string date, string symbol, int fileSequenceNumber, string chartFileName)
        {
            ...
            var percentGainSortedFile = Path.Combine(percentGainSortedDir, tradeNumber.ToString() + "_" + chartFileName);
            ...
            if (!File.Exists(percentGainSortedFile))
            {
        ...
        private List<TradeDispalyInfo> GetTradeDispalyInfos(List<Signal> signals, List<Trade> trades)
        {
            ...
            return tdis.OrderByDescending(t => t.ResultPercent).ToList();
        }
